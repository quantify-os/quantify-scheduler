...
|--------------------|:------------------------------------------------------------:|:-----------------------------------------------------------------------------:|
| v0.28.0            | [1.x.y](https://pypi.org/project/qblox-instruments/) | [>=1.0.0, <3.0.0](https://gitlab.com/qblox/releases/cluster_releases/-/releases/) |
...
|                    | [1.1.x](https://pypi.org/project/qblox-instruments/1.1.1/)   | [0.13.0](https://gitlab.com/qblox/releases/cluster_releases/-/releases/v0.13.0), [>=1.0.0, <3.0.0](https://gitlab.com/qblox/releases/cluster_releases/-/releases/) |
