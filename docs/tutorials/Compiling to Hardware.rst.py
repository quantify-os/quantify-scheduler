...
#
# We start by setting the directory where the compiled schedule files will be stored, via `set_datadir <https://quantify-quantify-core.readthedocs-hosted.com/en/latest/usage.py.html#data-directory>`_.
#
