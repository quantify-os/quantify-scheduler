...
- [ ] Pipeline fix or dependency update: post in `#software-for-developers` channel to merge `main` back in or [update local packages](https://quantify-quantify-scheduler.readthedocs-hosted.com/en/latest/user/installation.html#setting-up-for-local-development) (or N/A).
