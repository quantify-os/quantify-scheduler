...
def test_compilation_spectroscopy_operation_qblox_hardware(
    ...
    pulse_amplitude = quantum_device.get_element("qe0").spectroscopy_operation.amplitude.get()
...
def test_compilation_measure_qblox_hardware(mock_setup_basic_nv_qblox_hardware):
    ...
    _ = schedule.add(Measure("qe0", acq_index=0), label=label)
    measure_hash = Measure("qe0", acq_index=0).hash
