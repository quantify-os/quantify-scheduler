...
class ResetSpinpump(InstrumentModule):
    ...
    to reset the NV to the $|0\rangle$ state.
    """
...
class Measure(InstrumentModule):
    ...
    Excitation with a readout laser from the $|0\rangle$ to an excited state.
    Acquisition of photons when decaying back into the $|0\rangle$ state.
    """
